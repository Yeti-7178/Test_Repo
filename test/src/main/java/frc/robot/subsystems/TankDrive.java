...
public class TankDrive extends SubsystemBase {
    CANSparkMax m_Right1 = new CANSparkMax(Constants.OperatorConstants.kRightFrontPort , CANSparkLowLevel.MotorType.kBrushless );
    CANSparkMax m_Left1 = new CANSparkMax(Constants.OperatorConstants.kLeftFrontPort , CANSparkLowLevel.MotorType.kBrushless );
    CANSparkMax m_Right2 = new CANSparkMax(Constants.OperatorConstants.kRightRearPort , CANSparkLowLevel.MotorType.kBrushless );
    CANSparkMax m_Left2 = new CANSparkMax(Constants.OperatorConstants.kLeftRearPort , CANSparkLowLevel.MotorType.kBrushless );
